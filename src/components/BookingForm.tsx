...
Metode: ${method}`;
  ...
  return (
    <section className="py-16 md:py-24 px-4 md:px-6" id="booking">
      <div className="max-w-4xl mx-auto bg-white rounded-[2rem] md:rounded-[3rem] p-6 md:p-12 shadow-2xl border-4 md:border-8 border-primary/10 relative overflow-hidden">
        {/* Decorative Elements */}
